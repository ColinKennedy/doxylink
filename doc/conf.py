# -*- coding: utf-8 -*-
#
# sphinxcontrib-doxylink documentation build configuration file, created by
# sphinx-quickstart on Thu Aug 12 16:41:53 2010.
#
...
project = u'sphinxcontrib-doxylink'
copyright = u'2017, Matt Williams'
...
htmlhelp_basename = 'sphinxcontrib-doxylinkdoc'
...
latex_documents = [
  ('index', 'sphinxcontrib-doxylink.tex', u'sphinxcontrib-doxylink Documentation',
   u'Matt Williams', 'manual'),
]
...
man_pages = [
    ('index', 'sphinxcontrib-doxylink', u'sphinxcontrib-doxylink Documentation',
     [u'Matt Williams'], 1)
]
